...
//   Map<Position, StoneWidget?> playgroundMap = {}; // int gives player id
//   String id;
//   int time;
...
//           StoneWidget(int.parse(v.split(' ')[0]) == 0 ? Colors.black : Colors.white, clusterRefer[currentClusterID] as Position);
...
//       var j;
//       try {
//         j = StoneLogic.of(context)!.playgroundMap[Position.fromString(i)]!.value!.cluster;
//       } catch (Exception) {
