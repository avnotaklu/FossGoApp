...
//   DatabaseReference ourTimeAndDuration(context) => lastTimeAndDuration.child(GameData.of(context)!.getClientPlayerIndex(context).toString());
...
//       gameEndData.child("finalClusterConfirmation").child(GameData.of(context)!.getClientPlayerIndex(context).toString());
// }
