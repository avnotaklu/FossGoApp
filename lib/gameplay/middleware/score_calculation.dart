...
class ScoreCalculation extends InheritedWidget {
  final Map<Position, Area> areaMap = {};
  final List<Cluster> clusterEncountered = [];

  BuildContext? _context;
  Map<Position, Stone?> virtualPlaygroundMap = {};
  List<Cluster> virtualRemovedCluster = [];

  ScoreCalculation({required Widget mChild}) : super(child: mChild);
  ...
  calculateScore(BuildContext context) {
    ...
    // FIXME: just returing incorrect map for now to avoid errors
    return areaMap;
